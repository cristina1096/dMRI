...
"""
Timestep is decided by min(tortuosity, permeabiligy...) and gradient_strength:
Δt_actual = min(Δt_static, Δt_gradient);
Δt_gradient = [scaled_gradient_precision / |G|²]^(1/3)
"""
